    ...
    public static function items(): array
    {
        return [
            ...
            'external_movements.view' => [
                'label' => 'Dış Görev Ekranını Gör',
                'group' => 'Operasyon Akışı',
                'description' => 'Sahil veya dış hizmete çıkan personel/araç hareket ekranını açabilir.',
                'grant_hint' => 'Yönetim > Kullanıcı ve Yetki ekranında Operasyon Akışı bölümünden "Dış Görev Ekranını Gör" yetkisini açın. Modül ayrıca Yönetim ekranından aktif olmalıdır.',
            ],
            'external_movements.create_exit' => [
                'label' => 'Dış Görev Çıkışı Ver',
                'group' => 'Operasyon Akışı',
                'description' => 'Dış lokasyona çıkan kişi için bölüm, araç, km ve not bilgisiyle çıkış kaydı oluşturabilir.',
                'grant_hint' => 'Yönetim > Kullanıcı ve Yetki ekranında Operasyon Akışı bölümünden "Dış Görev Çıkışı Ver" yetkisini açın.',
            ],
            'external_movements.create_return' => [
                'label' => 'Dış Görev Girişi Ver',
                'group' => 'Operasyon Akışı',
                'description' => 'Dış görevden dönen kişi için dönüş km bilgisini girip kaydı kapatabilir.',
                'grant_hint' => 'Yönetim > Kullanıcı ve Yetki ekranında Operasyon Akışı bölümünden "Dış Görev Girişi Ver" yetkisini açın.',
            ],
            'categories.manage' => [
